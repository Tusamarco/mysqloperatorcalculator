...
func (family *Family) Init(DBTypeRequest string) map[string]Family {
	...
	innodbGroup := map[string]Parameter{
		...
		"innodb_flush_log_at_trx_commit": {"innodb_flush_log_at_trx_commit", "configuration", "innodb", "2", "1", 0, 2, MySQLVersions{V8_0_46, V11_1_1}},
		...
		"innodb_io_capacity_max":        {"innodb_io_capacity_max", "configuration", "innodb", "20000", "20000", 100, 0, MySQLVersions{V8_0_46, V11_1_1}},
		"innodb_numa_interleave":        {"innodb_numa_interleave", "configuration", "innodb", "0", "1", 0, 0, MySQLVersions{V8_0_46, V11_1_1}},
